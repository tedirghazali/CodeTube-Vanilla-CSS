(function (global, factory) {
	...
	(global.uploaderPreview = factory());
...
var uploaderPreview = function () {
    function uploaderPreview(uploadId) {
        ...
        this.el = document.querySelector('.cf[data-upload-id="' + this.uploadId + '"]');
        if (!this.el) {
            throw new Error('Could not find a `cf` with the id of: ' + this.uploadId);
        }
        this.input = this.el.querySelector('input[type="file"]');
        this.inputLabel = this.el.querySelector('.cf-control');
        this.imagePreview = this.el.querySelector('.cf-image-preview');
        this.clearButton = this.el.querySelector('.cf-image-clear');
    ...
    _createClass(uploaderPreview, [{
            ...
            this.input.addEventListener('change', function (event) {
                ...
                var _loop = function _loop(x) {
                    ...
                    reader.onload = function (e) {
                        self.imagePreview.classList.add('cf-image-preview-active');
                        ...
                        if (self.selectedFilesCount > 1) {
                            ...
                            if (self.showMultiple) {
                                if (self.onlyFirstImageSelected) {
                                    self.imagePreview.innerHTML += '<div class="cf-image-multi-preview" style="background-image: url(' + self.firstImage + '); "></div>';
                                ...
                                self.imagePreview.innerHTML += '<div class="cf-image-multi-preview" style="background-image: url(' + res + '); "></div>';
                            } else {
        ...
        value: function clearPreviewImage() {
            ...
            this.imagePreview.style.backgroundImage = 'url("' + this.baseImage + '")';
            this.imagePreview.classList.remove('cf-image-preview-active');
            this.cachedFileArray = [];
